...
export const indexTranslations = {
    en: {
        ...
        'experiences.doctolib.title': 'Doctolib - Software Engineering Intern',
        'experiences.doctolib.description': dedent`Fullstack development, critical infrastructure migration, product
                                                   specification and design, use of Agile methods.`,
        'experiences.reveals.title': 'Reveals - Fullstack Dev & Data Scientist Intern',
        'experiences.reveals.description': dedent`Application development for a major fund administrator,
                                                  project management, drafted specifications for a key application.`,
        'experiences.henoo.title': 'Henoo - Backend Developer Intern',
        'experiences.henoo.description': dedent`Backend (Java Spring Boot) development at a startup (social media app), 
                                                infrastructure monitoring, use of Agile methods.`,
        'experiences.cma.title': 'CMA GE - Dev & Data Scientist Intern',
        'experiences.cma.description': dedent`Work with ESB / ETL, data refinement pipelines, KPI visualization
                                              dashboards, database migration scripts.`,
    ...
    fr: {
        ...
        'experiences.doctolib.title': 'Doctolib - Stagiaire en Ingénierie Logicielle',
        'experiences.doctolib.description': dedent`Développement fullstack, migration d'infrastructures critiques,
                                                   spécification et conception produit, méthodes agiles.`,
        'experiences.reveals.title': 'Reveals - Stagiaire Développeur & Data Scientist',
        'experiences.reveals.description': dedent`Développement d'applications pour un administrateur de fonds majeur,
                                                  gestion de projet, rédaction de spécifications d'une app.`,
        'experiences.henoo.title': 'Henoo - Stagiaire Développeur Backend',
        'experiences.henoo.description': dedent`Développement Java Spring Boot dans une startup (application de réseau social),
                                                monitoring de l'infrastructure, méthodes agiles.`,
        'experiences.cma.title': 'CMA GE - Stagiaire Développeur & Data Scientist',
        'experiences.cma.description': dedent`Travail sur ESB / ETL, pipelines de raffinage de données, tableaux de bord pour KPI,
